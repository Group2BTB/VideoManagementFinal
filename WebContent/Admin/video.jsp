	...
	<div class="page-container">
				...
				<div class="col-md-12 col-sm-12 col-xs-12 clearfix">
					...
					<div class="panel panel-primary">
						...
						<div class="panel-heading">
							<i class="glyphicon glyphicon-facetime-video"></i> List video
						</div>
						...
						<table class="table table-bordered table-hover"
							...
							<tr class="active" style="cursor: pointer;">
								<th class="center">No&nbsp;<a
									ng-click="sort_by('video_id');"><i
										class="glyphicon glyphicon-sort"></i></a></th>
								<th class="center">Name&nbsp;<a
									ng-click="sort_by('video_name');"><i
										class="glyphicon glyphicon-sort"></i></a></th>
								<th class="center">Create By&nbsp;<a
									ng-click="sort_by('');"><i class="glyphicon glyphicon-sort"></i></a></th>
								<th class="center">Status&nbsp;<a
									ng-click="sort_by('status');"><i
										class="glyphicon glyphicon-sort"></i></a></th>
								<th class="center">Statistics &nbsp;<a
							...
							<tr
								...
								<td><i class="glyphicon glyphicon-stats"></i>{{d.view}} <i
									class="glyphicon glyphicon-comment"></i>{{d.comment}} <br>
									<i class="glyphicon glyphicon-thumbs-up"></i>{{d.like}} <i
									class="glyphicon glyphicon-thumbs-down"></i>{{d.unlike}}</td>
								<td class="center">
			...
			<div id="myModal" class="modal fade bs-example-modal-lg">
				<div class="modal-dialog">
					<div class="modal-content" style="margin: 0 auto;">
						<form method="post" action="" id="frmVideo">
							<div class="modal-header" style="text-align: center;">
								<button type="button" class="close" data-dismiss="modal"
									aria-label="Close">
									<span aria-hidden="true">&times;</span>
								</button>
								<h1 class="modal-title" style="font-variant: small-caps;">
									<b>Video</b>
							...
							<div class="modal-body">
								<div class="form-group">
									<label for="name">Name <span class="require_field">*</span>
										:
									</label> <input type="text" ng-model="name" class="form-control"
								...
								<div class="form-group">
									<label for="status">Status <span class="require_field">*</span>
										:
									</label> <select class="form-control" ng-model="status" id="status"
										name="status">
										<option></option>
								...
								<div class="form-group">
									...
									<textarea class="form-control max_textarea"
										ng-model="description" name="description" id="description"
										rows="3"> </textarea>
		...
		<script>
				...
				$.ajax({
					...
					success : function(data) {
						if (data) {
							var str = "";
							for (var i = 0; i < data.length; i++) {
								str += "<option value='"+data[i].document_name+"'>"
			...
			function clear(){
				...
				$('#document').prepend("<option></option>");
