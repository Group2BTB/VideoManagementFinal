...
<html ng-app="myApp" ng-controller="videocontroller">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12 clearfix">
			...
			<div class="panel panel-primary">
				...
				<div class="panel-heading"><i class="glyphicon glyphicon-facetime-video"></i> List video</div>
				...
				<table class="table table-bordered table-hover" ng-show="filteredItems > 0">
					<tr class="active" style="cursor:pointer;">
						<th class="center">No&nbsp;<a ng-click="sort_by('video_id');"><i class="glyphicon glyphicon-sort"></i></a></th>
        				<th class="center">Name&nbsp;<a ng-click="sort_by('video_name');"><i class="glyphicon glyphicon-sort"></i></a></th>        			
        	        	<th class="center">Create By&nbsp;<a ng-click="sort_by('');"><i class="glyphicon glyphicon-sort"></i></a></th>
        	        	<th class="center">Status&nbsp;<a ng-click="sort_by('status');"><i class="glyphicon glyphicon-sort"></i></a></th>
        	        	<th class="center">Statistics &nbsp;<a ng-click="sort_by('status');"></a></th>
					...
					<tr ng-repeat="d in filtered = (list | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit">
						...
						<td>
							<i class="glyphicon glyphicon-stats"></i>{{d.view}}
							<i class="glyphicon glyphicon-comment"></i>{{d.comment}}				
							<br>
							<i class="glyphicon glyphicon-thumbs-up"></i>{{d.like}}
							<i class="glyphicon glyphicon-thumbs-down"></i>{{d.unlike}}						
						</td>	
						<td class="center">
			...
			<div class="modal-content" style="margin: 0 auto;">
				<form method="post" action="" id="frmDepartment">
					<div class="modal-header" style="text-align: center;">
						...
						<h1 class="modal-title" style="font-variant: small-caps;"><b>Video</b>
					...
					<div class="modal-body">							
						...
						<div class="form-group">
							<label for="url">URL<span class="require_field">*</span> : </label>
							<input type="url" ng-model="url" class="form-control" name="url" id="url" placeholder="Youtube URL...">
						</div>
						
						<div class="form-group">
							<label for="partent">Document :</label>
							<select name="test" ng-model="document" ng-model="document" id="document" name="document" class="select2 form-control" data-allow-clear="true"
						...
						<div class="form-group">
							...
							<textarea class="form-control max_textarea" ng-model="description" name="description" id="description" rows="3"> </textarea>
		...
		$.ajax({
			...
			success : function(data) {
				if(data){
					var str="";
					for(var i=0;i<data.length;i++){
						str +="<option value='"+data[i].document_name+"'>"+data[i].document_name+"</option>";
					}
					$("#document").append(str);
				}
			},
