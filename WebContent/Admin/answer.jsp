	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12 clearfix">
			...
			<div class="panel panel-primary">
				...
				<div class="panel-heading"><i class="glyphicon glyphicon-question-sign"></i> List Answer</div>
				...
				<table class="table table-bordered table-hover" ng-show="filteredItems > 0">
					<tr class="active" style="cursor:pointer;">
        				...
        				<th class="center">Answer&nbsp;<a ng-click="sort_by('description');"><i class="glyphicon glyphicon-sort"></i></a></th>        			
			...
			<div class="modal-content" style="margin: 0 auto;">
				<form method="post" action="" id="frmDepartment">
					<div class="modal-header" style="text-align: center;">
						...
						<h1 class="modal-title" ><b>A</b>nswer
					...
					<div class="modal-body">						
						<div class="form-group">
							<label for="name">Answer <span class="require_field">*</span> : </label>
							<input type="text" class="form-control" id="name" name="name" ng-model="name" placeholder="Question...">
						</div>
						<div class="form-group">
							<label for="question">Question <span class="require_field">*</span> :</label>
							<select name="question" id="question" ng-model="question" class="select2 form-control" data-allow-clear="true"
