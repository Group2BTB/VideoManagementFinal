...
.vcount{
	position: absolute;
	background-color: gray no-repeat right top;
	color: white;
	padding:6px;
	margin:auto;
   	    margin-right: 200px;
					...
					<div class="panel-heading" style="background-color: #558d48">
						<ul class="nav nav-tabs">							
							...
							<li class=""><a href="#panel-watch-later" data-toggle="tab" aria-expanded="false"><i class="fa  fa-clock-o"></i> Watch
									Later</a></li>
							<li class="active"><a href="#panel-courses" data-toggle="tab" aria-expanded="true"><i class="fa  fa-book"></i> Courses
									</a></li>
							<li class="pull-right">
														...
														<div class="media-body" style="overflow: visible">
															...
															<div class="progress">
															    <div class="progress-bar progress-bar-success progress-bar-striped" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width:70%">
															    	<span class="text-info" style="color: #fff"><i class="fa fa-clock-o"></i>
...
<div class="vblock">
														...
														<div class="media-body" style="overflow: visible">
															...
															<ul class="list-inline">
																...
																<br>
																<a><span class="small text-muted" style="color: #AAB2BD"> by Admin</span></a></li>
															</ul>
															<p class="hidden-xs"></p>
															<span class="small text-muted" style="color: #AAB2BD"><i class="fa fa-eye">&nbsp;&nbsp;2093</i> &nbsp;&nbsp;&nbsp;
															</span><br><br>
